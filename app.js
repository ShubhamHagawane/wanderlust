...
const bookings = require("./routes/booking.js");  // Add this
...
app.use("/",userRouter);
app.use("/", bookings);  // Add this
app.use("/", categories); 
app.use("/", hostProfiles);  // Add this
...
app.use((err,req,res,next)=>{
    let {statusCode = 500 , message = "somtehing went wrong"} = err;
